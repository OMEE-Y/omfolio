...
export const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#050505] text-white selection:bg-white selection:text-black border-t border-white/[0.03]">
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24 flex flex-col items-center">
        ...
        <div className="relative mb-16 md:mb-24 text-center group/quote w-full">
          ...
          <div className="absolute inset-0 bg-white/[0.02] blur-[60px] md:blur-[120px] rounded-full -z-10" />
          
          <p className="text-xl md:text-4xl font-light tracking-tight text-zinc-200 leading-relaxed mb-8 md:mb-12 px-2">
            “{quote.v}”
          </p>
          
          <div className="inline-flex items-center justify-center gap-4 md:gap-6 w-full">
            <div className="h-px flex-1 max-w-[40px] bg-white/10 group-hover/quote:max-w-[60px] transition-all duration-700 ease-in-out" />
            <span className="text-[9px] md:text-[10px] font-mono uppercase tracking-[0.3em] md:tracking-[0.6em] text-zinc-500 group-hover/quote:text-zinc-300 transition-colors duration-500 whitespace-nowrap">
              {quote.c}
            </span>
            <div className="h-px flex-1 max-w-[40px] bg-white/10 group-hover/quote:max-w-[60px] transition-all duration-700 ease-in-out" />
          </div>
        ...
        {/* Bottom Row */}
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-white/[0.03]">
          ...
          <div className="flex items-center gap-3.5 group/loc cursor-default">
            ...
            <p className="text-[9px] font-mono tracking-[0.3em] text-zinc-500 group-hover/loc:text-zinc-300 transition-colors uppercase">
              Mumbai, India
            </p>
          </div>

          <div className="flex items-center">
            <span className="text-[9px] font-mono tracking-[0.3em] text-zinc-600 hover:text-zinc-300 transition-colors uppercase">
              © 2026 OM YEWALE
            </span>
          </div>
